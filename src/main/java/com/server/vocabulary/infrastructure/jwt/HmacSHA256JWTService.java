...
import com.server.vocabulary.domain.jwt.JWTDeserializer;
import com.server.vocabulary.domain.jwt.JWTPayload;
import com.server.vocabulary.domain.jwt.JWTSerializer;
import com.server.vocabulary.domain.user.User;

import java.util.regex.Pattern;

import static com.server.vocabulary.infrastructure.jwt.Base64URL.*;
